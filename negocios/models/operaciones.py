...
from .negocio import Negocio, PuestoNegocio, TarifasNegocio, Sede
...
class Reserva(PostgresPartitionedModel, ModelCore):
    ...
    sede = models.ForeignKey(Sede, related_name='reservas', on_delete=models.DO_NOTHING)
    ...
    tarifa = models.ForeignObject(
        TarifasNegocio,
        from_fields=('sede_id', 'tipo_vehiculo_id', 'tiempo'),
        to_fields=('sede_id', 'tipo_vehiculo_id', 'tiempo'),
        on_delete=models.DO_NOTHING,
        related_name='reservas'
    )
